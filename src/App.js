...
const App = () => {
  ...
  const handleAnswerSelect = selectedOption => {
    ...
    if (selectedOption === correctAnswer) {
      setResultMessage(
        `Congratulations! The correct answer is ${correctAnswer}`,
      )
    } else {
  ...
  return (
    <>
      ...
      <p className="mp">
        1.After Submitting a question it will automatically navigate to the next
        question
      </p>
      <p className="mp">{}2.If any issue occured please reload the page.</p>
